...
8. 鼠标移入小窗底部：显示播放/暂停、进度条、倍速按钮、弹幕开关。
9. 关闭透明小窗后，原 B 站网页的视频进度会同步到小窗最新播放进度；再次点击“透明”会从同步后的进度继续。
...
6. 鼠标移入小窗底部可以拖动进度条，也可以点击倍速按钮展开菜单，直接选择 `0.75x / 1x / 1.25x / 1.5x / 2x / 3x / 4x / 5x`。
...
控制条只在鼠标移入小窗时显示。把鼠标移动到小窗底部即可看到播放按钮、进度条、倍速按钮和弹幕开关。
